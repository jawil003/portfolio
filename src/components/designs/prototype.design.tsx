 ...
 * @version 0.1
 */
const PrototypeDesign: React.FC<Props> = ({ width, height }) => {
  return (
    <svg
    ...
    >
      ...
      ></path>
      <path fill="#b6c4cf" d="M283.55 96h190.645v291.688H283.55z"></path>
      <path fill="#9facba" d="M283.55 108.411H330V259.73h-46.45z"></path>
      <path
        fill="#596c76"
      ...
      ></path>
      <path fill="#7a8c98" d="M283.55 336.21h190.645v51.479H283.55z"></path>
      <path fill="#596c76" d="M283.55 336.209H330v51.479h-46.45z"></path>
      <path
        fill="#b6c4cf"
      ...
      ></path>
      <path fill="#e8edf2" d="M283.55 284.731h190.645v51.479H283.55z"></path>
      <path fill="#d9e7ec" d="M283.55 284.731H330v51.479h-46.45z"></path>
      <path
        fill="#8d9ca8"
      ...
      ></path>
      <path fill="#8d9ca8" d="M283.55 259.731h190.645v25H283.55z"></path>
      <path fill="#7a8c98" d="M283.55 259.731H330v25h-46.45z"></path>
      <path
        fill="#01d0fb"
      ...
      ></path>
      <path fill="#01d0fb" d="M37.805 336.21H228.45v51.479H37.805z"></path>
      <path fill="#01c0fa" d="M37.805 336.209H84v51.479H37.805z"></path>
      <path fill="#7a8c98" d="M37.805 159.89H228.45v51.479H37.805z"></path>
      <path fill="#596c76" d="M37.805 159.89H84v51.479H37.805z"></path>
      <path fill="#99e6fc" d="M37.805 108.411H228.45v51.479H37.805z"></path>
      <path fill="#62dbfb" d="M37.805 108.411H84v51.479H37.805z"></path>
      <g>
        <path fill="#7a8c98" d="M37.805 284.731H228.45v51.479H37.805z"></path>
      </g>
      <g>
        <path fill="#596c76" d="M37.805 284.731H84v51.479H37.805z"></path>
      </g>
      <g>
        <path fill="#b6c4cf" d="M37.805 211.369H228.45v73.361H37.805z"></path>
        <path fill="#9facba" d="M37.805 211.369H84v73.361H37.805z"></path>
      </g>
      <g>
        <path
          fill="#e8edf2"
      ...
      <g>
        ...
        <circle cx="409.177" cy="361.949" r="7.5"></circle>
        <circle cx="389.341" cy="362.107" r="7.5"></circle>
        ...
        <circle cx="395.401" cy="412.798" r="7.5"></circle>
        <circle cx="395.401" cy="435.94" r="7.5"></circle>
        <circle cx="413.401" cy="412.798" r="7.5"></circle>
        <circle cx="413.401" cy="435.94" r="7.5"></circle>
        <circle cx="431.401" cy="412.798" r="7.5"></circle>
        <circle cx="431.401" cy="435.94" r="7.5"></circle>
        <circle cx="449.401" cy="412.798" r="7.5"></circle>
        <circle cx="449.401" cy="435.94" r="7.5"></circle>
        ...
        <circle cx="409.177" cy="310.47" r="7.5"></circle>
        <circle cx="389.341" cy="310.628" r="7.5"></circle>
        ...
        <circle cx="395.401" cy="60.16" r="7.5"></circle>
        <circle cx="395.401" cy="83.302" r="7.5"></circle>
        <circle cx="413.401" cy="60.16" r="7.5"></circle>
        <circle cx="413.401" cy="83.302" r="7.5"></circle>
        <circle cx="431.401" cy="60.16" r="7.5"></circle>
        <circle cx="431.401" cy="83.302" r="7.5"></circle>
        <circle cx="449.401" cy="60.16" r="7.5"></circle>
        <circle cx="449.401" cy="83.302" r="7.5"></circle>
        ...
        <circle cx="163.432" cy="361.949" r="7.5"></circle>
        <circle cx="143.596" cy="362.106" r="7.5"></circle>
        ...
        <circle cx="102.823" cy="185.63" r="7.5"></circle>
        <circle cx="122.659" cy="185.472" r="7.5"></circle>
        ...
        <circle cx="163.432" cy="310.47" r="7.5"></circle>
        <circle cx="143.596" cy="310.627" r="7.5"></circle>
        ...
        <circle cx="149.655" cy="236.479" r="7.5"></circle>
        <circle cx="149.655" cy="259.621" r="7.5"></circle>
        <circle cx="167.655" cy="236.479" r="7.5"></circle>
        <circle cx="167.655" cy="259.621" r="7.5"></circle>
        <circle cx="185.655" cy="236.479" r="7.5"></circle>
        <circle cx="185.655" cy="259.621" r="7.5"></circle>
        <circle cx="203.655" cy="236.479" r="7.5"></circle>
        <circle cx="203.655" cy="259.621" r="7.5"></circle>
        ...
        <circle cx="149.655" cy="60.16" r="7.5"></circle>
        <circle cx="149.655" cy="83.302" r="7.5"></circle>
        <circle cx="167.655" cy="60.16" r="7.5"></circle>
        <circle cx="167.655" cy="83.302" r="7.5"></circle>
        <circle cx="185.655" cy="60.16" r="7.5"></circle>
        <circle cx="185.655" cy="83.302" r="7.5"></circle>
        <circle cx="203.655" cy="60.16" r="7.5"></circle>
        <circle cx="203.655" cy="83.302" r="7.5"></circle>
        ...
        <circle cx="102.823" cy="134.151" r="7.5"></circle>
        <circle cx="122.659" cy="133.993" r="7.5"></circle>
        ...
        <circle cx="149.655" cy="412.798" r="7.5"></circle>
        <circle cx="149.655" cy="435.94" r="7.5"></circle>
        <circle cx="167.655" cy="412.798" r="7.5"></circle>
        <circle cx="167.655" cy="435.94" r="7.5"></circle>
        <circle cx="185.655" cy="412.798" r="7.5"></circle>
        <circle cx="185.655" cy="435.94" r="7.5"></circle>
        <circle cx="203.655" cy="412.798" r="7.5"></circle>
        <circle cx="203.655" cy="435.94" r="7.5"></circle>
        ...
        <circle cx="409.177" cy="135" r="7.5"></circle>
        <circle cx="389.341" cy="135.157" r="7.5"></circle>
