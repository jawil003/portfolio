...
/**
 * An LikedInIcon React Component.
 * @author Jannik Will
 * @version 0.1
 */
const LinkedInIcon: React.FC<Props> = ({ width, height, color, textColor }) => {
  return (
    <svg
...
LinkedInIcon.defaultProps = { color: "#069" };
