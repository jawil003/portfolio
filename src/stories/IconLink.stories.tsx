...
} from "../components/elements/generic/IconLink";
import DribbleIcon from "../components/icons/dribble.icon";

export default { title: "Elements/IconLink", component: IconLink } as Meta;

const IconLinkElement: Story<IconLinkProps> = (args) => (
  <IconLink {...args}>
