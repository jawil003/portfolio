...
export const CPlusPlusIcon: React.FC<Props> = ({
  fontSize,
}) => {
  return (
    <svg
    ...
    >
      ...
      <path
        fill="#FFF"
        d="M255 166.508L243.666 166.508 243.666 155.175 232.334 155.175 232.334 166.508 221 166.508 221 177.841 232.334 177.841 232.334 189.175 243.666 189.175 243.666 177.841 255 177.841z"
      ></path>
      <path
        fill="#FFF"
        d="M297.5 166.508L286.166 166.508 286.166 155.175 274.834 155.175 274.834 166.508 263.5 166.508 263.5 177.841 274.834 177.841 274.834 189.175 286.166 189.175 286.166 177.841 297.5 177.841z"
      ></path>
    </svg>
  );
};
